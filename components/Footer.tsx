      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-white/10 pb-12">
        <div className="col-span-1 md:col-span-1">
          ...
          <div className="flex gap-4">
            {[Instagram, Facebook, Twitter].map((Icon, i) => (
              <a key={i} href="#" className="w-10 h-10 border border-white/20 rounded-full flex items-center justify-center hover:bg-lemonGreen hover:text-black hover:border-lemonGreen transition-all">
                <Icon size={18} />
              </a>
            ))}
          </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-400">
            <li><Link to="/" className="hover:text-lemonGreen transition-colors">Home</Link></li>
            <li><Link to="/about" className="hover:text-lemonGreen transition-colors">About Us</Link></li>
            <li><Link to="/contact" className="hover:text-lemonGreen transition-colors">Contact Us</Link></li>
            <li><a href="https://Nayisochhamarikalpana.org" className="hover:text-lemonGreen transition-colors">Nayisochhamarikalpana.org</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-400">
            ...
            <li className="flex items-center gap-3">
              <Mail size={18} className="text-lemonGreen shrink-0" />
        ...
        <div>
          ...
          <form className="relative">
            <input 
              ...
              className="w-full bg-white/10 border border-white/20 rounded-lg py-3 px-4 text-sm focus:outline-none focus:border-lemonGreen transition-colors"
            />
            <button className="absolute right-2 top-2 bottom-2 px-4 bg-lemonGreen text-black font-bold text-xs rounded-md">
              Join
            </button>
          </form>
        </div>
